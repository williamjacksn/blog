...
where ![f^r_{fb}]({static}/images/2005-05-13-eqn2.png) is the number of real friends you have on the[Facebook](http://www.facebook.com/), and ![f^i_{fb}]({static}/images/2005-05-13-eqn3.png) is the number of imaginary friendsyou have on the [Facebook](http://www.facebook.com/), e.g. Strong Sad.
